...
class ApiClient {
    ...
    try {
      ...
      if (error.response?.status === 401 && this.refreshToken) {
        ...
        if (newAccessToken) {
          ...
          // Refresh token a échoué ou retourné null
   ...
   * Émet un événement que le contexte d'authentification peut écouter
   */
  handleUnauthorized() {
    this.logout();
